                ...
                <ul className="space-y-4">
                    ...
                    <li>
                        <button 
                            ...
                            className="w-full flex items-center px-4 py-2 hover:bg-slate-700 dark:hover:bg-slate-800"
                        >
                            <MdSettings className="text-xl text-white dark:text-slate-200" />
                            {!isCollapsed && <span className="ml-3 text-white dark:text-slate-200">Settings</span>}
                        </button>
                    </li>
                </ul>
            </div>
